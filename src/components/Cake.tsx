    ...
    <div className="flex flex-col items-center justify-center h-full w-full cursor-pointer" onClick={blowCandles}>
      ...
      <div className="mt-8 text-center">
        ...
        <button 
          ...
          className="px-8 py-3 bg-yellow-400 rounded-xl font-heading font-bold text-gray-800 shadow-md hover:bg-yellow-300 transition-all transform hover:scale-105 active:scale-95 uppercase tracking-wide"
        >
          Celebrate!
        </button>
      </div>
